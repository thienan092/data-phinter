...
| Purpose | Diagnosis, hardening review, source patch, artifact capture, or handoff update. |
...
| Handoff delta | What durable conclusion must be added to `effective-verbal-context.md`. |
...
- Track whether predictions were confirmed, falsified, or still pending in the handoff.
